...
<head>
    ...
    <title>Add Recipe - Godsmack</title>
...
<div class="container my-5">
    <h1 class="display-5 fw-bold mb-4"><i class="bi bi-plus-circle"></i> Add new recipe</h1>
    ...
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-body p-4">
            <form method="POST" action="process_recept.php" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label class="form-label fw-semibold">Recipe picture:</label>
                    <div class="border-3 border-dashed rounded-4 p-5 text-center" style="border-color: #dee2e6; cursor: pointer;" onclick="document.getElementById('fileInput').click()">
                        ...
                        <p class="mt-3 mb-0 text-muted">Click or drag picture here</p>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Time to make:</label>
                        ...
                        <div class="row mb-2 align-items-end">
                            ...
                            <div class="col-md-3">
                                <select name="sastojak_jedinica[]" class="form-select" required>
                                    ...
                                    <option value="kasika">spoon</option>
                                    <option value="kasicica">tea spoon</option>
                                    <option value="solja">cup</option>
                                </select>
                            </div>
                            <div class="col-md-1">
                ...
                <div class="mb-4">
                    <label class="form-label fw-semibold">How to make:</label>
                ...
                <div class="d-flex gap-3">
                    <button type="submit" class="btn btn-primary-custom btn-lg flex-grow-1">
                        <i class="bi bi-check-circle"></i> Publish recipe
                    </button>
